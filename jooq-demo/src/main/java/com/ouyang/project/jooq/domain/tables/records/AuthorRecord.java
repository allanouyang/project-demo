...
*/
package com.ouyang.project.jooq.domain.tables.records;
...
public class AuthorRecord extends UpdatableRecordImpl<AuthorRecord> implements Record6<Long, String, String, Date, Integer, Byte> {

    private static final long serialVersionUID = 301194658;
     ...
     */
    @Override
    public Row6<Long, String, String, Date, Integer, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row6<Long, String, String, Date, Integer, Byte> valuesRow() {
     ...
     */
    @Override
    public AuthorRecord values(Long value1, String value2, String value3, Date value4, Integer value5, Byte value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AuthorRecord(Long id, String firstName, String lastName, Date dateOfBirth, Integer yearOfBirth, Byte distinguished) {
        super(Author.AUTHOR);
